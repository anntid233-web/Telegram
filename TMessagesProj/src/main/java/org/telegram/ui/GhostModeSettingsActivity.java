 ...
 * Хранение состояния — обычный SharedPreferences ("aerogram_config").
 */
public class GhostModeSettingsActivity extends BaseFragment {
    ...
    private int infoRow2;
    private int useDelayRow;
    private int infoRow3;
            ...
            switch (holder.getItemViewType()) {
                ...
                case 1: {
                    ...
                    if (position == ghostModeRow) {
                        ...
                        cell.setTextAndCheck("Автоматический «офлайн»", pref("ghost_auto_offline", true), false);
                    } else if (position == readOnActionRow) {
                        cell.setTextAndValueAndCheck("Читать при действиях",
                                "Автоматически читает сообщение при отправке нового или при реакции",
                                pref("ghost_read_on_action", true), true, false);
                    } else if (position == useDelayRow) {
